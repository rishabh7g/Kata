...
- **Concept Page** — ~1 page of prose explaining the concept, written to `docs/design.md` § Editorial standard. The first draft is LLM-generated; how much human editing followed varies by pack, and the page's own first line — the provenance note (`docs/engineering.md` § 5), which no screen renders — is the record of it. Read-only content, no interaction.
